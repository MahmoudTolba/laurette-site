        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 px-9 ">
          ...
          >
            <div class="relative aspect-[4/5] w-full bg-background rounded-md overflow-hidden flex items-center justify-center p-4">
              ...
              <span v-if="product.onSale" class="absolute top-3 left-3 bg-secondary text-white text-xs font-semibold px-3 py-1 uppercase z-10">
                Sale
              </span>
  
              <span v-if="product.isNew" class="absolute top-3 right-3 bg-dark text-white text-[11px] font-bold px-2 py-0.5 rounded-sm flex items-center gap-1 z-10" dir="rtl">
                <span>جديد</span>
            ...
            <div class="flex flex-col items-center text-center mt-4 flex-1 space-y-2">
              ...
              <div class="w-full pt-2 mt-auto">
                <button class="w-full bg-dark hover:bg-primary text-white text-xs uppercase font-bold py-3 tracking-wider transition-colors duration-300 shadow-sm rounded-sm">
                  Add to Cart
                </button>
              </div>
            </div>
