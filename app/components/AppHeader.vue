      ...
      <div class="flex items-center gap-1 md:gap-3 flex-1 justify-end">
        <div class="relative hidden sm:block group max-w-[150px] lg:max-w-xs w-full">
          <input
            ...
            class="w-full rounded-full py-2 pr-4 pl-10 outline-none transition-all duration-300 text-sm"
            :class="isHomePage
          ...
          <Icon
            name="uil:search"
            class="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 transition-colors group-focus-within:text-primary"
    ...
    <Transition name="slide">
      <aside v-if="isMenuOpen" class="fixed top-0 left-0 h-full w-[280px] bg-white z-[120] shadow-[10px_0_30px_rgba(0,0,0,0.1)] lg:hidden flex flex-col" dir="ltr">
        ...
        <div class="mt-auto p-6 border-t border-outline/30">
          <button class="w-full bg-gradient-to-r from-secondary to-primary text-white py-3 rounded-xl font-bold shadow-lg shadow-primary/20">
            Login / Sign Up
          </button>
        </div>
      </aside>
